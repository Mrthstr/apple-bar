    ...
    <>
      ...
      <main style={{ background: "var(--body-bg)" }}>
        ...
        <div className="bonus-block page-section">
          ...
          <button style={{ background: "#6b1428", color: "#fff", border: "none", padding: "13px 24px", borderRadius: 10, fontSize: 13, fontFamily: "inherit", cursor: "pointer", whiteSpace: "nowrap" }}>
            Зарегистрироваться
          </button>
          </div>
        </div>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div>
                ...
                <div style={{ fontSize: 13, color: "#999" }}>10:00 — 20:00, ежедневно · <a href="tel:+79243921311" style={{ color: "#6b1428", textDecoration: "none" }}>+7 (924) 392-13-11</a></div>
              </div>
              <div>
                ...
                <div style={{ fontSize: 13, color: "#999" }}>10:00 — 20:00, ежедневно · <a href="tel:+79939391806" style={{ color: "#6b1428", textDecoration: "none" }}>+7 (993) 939-18-06</a></div>
              </div>
            </div>
          </div>
          <div style={{
            background: "linear-gradient(135deg, #2e0f18 0%, #1a0810 100%)",
        ...
        <footer style={{ marginTop: 32, borderTop: "1px solid #e8e0e3", background: "#fff" }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            {[{ label: "Telegram", href: "https://t.me/applebarIRK" }].map(({ label, href }) => (
              <a key={label} href={href} target="_blank" rel="noopener noreferrer" title={label} style={{ width: 40, height: 40, border: "1px solid #e8e0e3", borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#aaa", textDecoration: "none" }}>
